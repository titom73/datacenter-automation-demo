...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.73.254.3/24 | 10.73.254.253 |
...
| --------- | --------------- | ------------ | --------- |
| pod01 | Vlan4094 | 172.31.253.5 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_switch04_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| ethernet5 | SWITCH13_ethernet1 | *trunk | *110 | *- | *- | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| ethernet1 | P2P_LINK_TO_SWITCH01_ethernet1 | routed | - | 172.31.255.9/31 | default | 9000 | false | - | - |
| ethernet2 | P2P_LINK_TO_SWITCH02_ethernet1 | routed | - | 172.31.255.11/31 | default | 9000 | false | - | - |
...
!
interface ethernet1
   description P2P_LINK_TO_SWITCH01_ethernet1
   no shutdown
   mtu 9000
   no switchport
...
!
interface ethernet2
   description P2P_LINK_TO_SWITCH02_ethernet1
   no shutdown
   mtu 9000
   no switchport
...
!
interface Ethernet3
   description MLAG_PEER_switch04_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface ethernet5
   description SWITCH13_ethernet1
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_switch04_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
...
interface Port-Channel3
   description MLAG_PEER_switch04_Po3
   no shutdown
   switchport
...
| Vlan3009 |  TENANT_A_CLIENT  |  172.31.253.6/31  |  -  |  -  |  -  |  -  |  -  |
...
| 172.31.253.7 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | TENANT_A_CLIENT | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 192.168.1.5:10110 | 10110:10110 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| TENANT_A_CLIENT | 192.168.1.5:10 | connected<br>static |
