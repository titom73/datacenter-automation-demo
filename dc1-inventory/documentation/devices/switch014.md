...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| ethernet1 | SWITCH05_ethernet4 | *trunk | *- | *- | *- | 1 |
| ethernet2 | SWITCH06_ethernet4 | *trunk | *- | *- | *- | 1 |
...
!
interface ethernet1
   description SWITCH05_ethernet4
   no shutdown
   channel-group 1 mode active
!
interface ethernet2
   description SWITCH06_ethernet4
   no shutdown
   channel-group 1 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | POD02_Po4 | switched | trunk | - | - | - | - | - | - | - |
