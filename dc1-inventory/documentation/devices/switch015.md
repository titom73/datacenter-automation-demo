...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| ethernet1 | SWITCH07_ethernet4 | *trunk | *- | *- | *- | 1 |
| ethernet2 | SWITCH08_ethernet4 | *trunk | *- | *- | *- | 1 |
...
!
interface ethernet1
   description SWITCH07_ethernet4
   no shutdown
   channel-group 1 mode active
!
interface ethernet2
   description SWITCH08_ethernet4
   no shutdown
   channel-group 1 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | POD03_Po4 | switched | trunk | - | - | - | - | - | - | - |
