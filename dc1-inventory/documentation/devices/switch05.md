...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.73.254.5/24 | 10.73.254.253 |
...
| --------- | --------------- | ------------ | --------- |
| pod02 | Vlan4094 | 172.31.253.9 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_switch06_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| ethernet5 | SWITCH14_ethernet1 | *trunk | *111 | *- | *- | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| ethernet1 | P2P_LINK_TO_SWITCH01_ethernet3 | routed | - | 172.31.255.17/31 | default | 9000 | false | - | - |
| ethernet2 | P2P_LINK_TO_SWITCH02_ethernet3 | routed | - | 172.31.255.19/31 | default | 9000 | false | - | - |
...
!
interface ethernet1
   description P2P_LINK_TO_SWITCH01_ethernet3
   no shutdown
   mtu 9000
   no switchport
...
!
interface ethernet2
   description P2P_LINK_TO_SWITCH02_ethernet3
   no shutdown
   mtu 9000
   no switchport
...
!
interface Ethernet3
   description MLAG_PEER_switch06_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface ethernet5
   description SWITCH14_ethernet1
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_switch06_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
| Port-Channel5 | SWITCH14_Po1 | switched | trunk | 111 | - | - | - | - | 5 | - |
...
interface Port-Channel3
   description MLAG_PEER_switch06_Po3
   no shutdown
   switchport
...
| Vlan3010 |  TENANT_A_SERVER  |  172.31.253.10/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4093 |  default  |  172.31.253.10/31  |  -  |  -  |  -  |  -  |  -  |
| Vlan4094 |  default  |  172.31.253.8/31  |  -  |  -  |  -  |  -  |  -  |
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- |
| 172.31.253.11 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | default | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
...
| 172.31.253.11 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | TENANT_A_SERVER | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 111 | 192.168.1.7:10111 | 10111:10111 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| TENANT_A_SERVER | 192.168.1.7:11 | connected<br>static |
...
router bgp 65102
   ...
   neighbor 172.31.253.11 peer group MLAG-IPv4-UNDERLAY-PEER
   neighbor 172.31.253.11 description switch06
   neighbor 172.31.255.16 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.16 remote-as 65001
   neighbor 172.31.255.16 description switch01_ethernet3
   neighbor 172.31.255.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 172.31.255.18 remote-as 65001
   neighbor 172.31.255.18 description switch02_ethernet3
