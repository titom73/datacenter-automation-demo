...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| ethernet1 | SWITCH03_ethernet5 | *trunk | *110 | *- | *- | 1 |
| ethernet2 | SWITCH04_ethernet5 | *trunk | *110 | *- | *- | 1 |
...
!
interface ethernet1
   description SWITCH03_ethernet5
   no shutdown
   channel-group 1 mode active
!
interface ethernet2
   description SWITCH04_ethernet5
   no shutdown
   channel-group 1 mode active
!
interface Ethernet4
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | POD01_Po5 | switched | trunk | 110 | - | - | - | - | - | - |
