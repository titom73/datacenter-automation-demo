...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| ethernet1 | SWITCH03_ethernet4 | *trunk | *- | *- | *- | 1 |
| ethernet2 | SWITCH04_ethernet4 | *trunk | *- | *- | *- | 1 |
...
!
interface ethernet1
   description SWITCH03_ethernet4
   no shutdown
   channel-group 1 mode active
!
interface ethernet2
   description SWITCH04_ethernet4
   no shutdown
   channel-group 1 mode active
```
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel1 | POD01_Po4 | switched | trunk | - | - | - | - | - | - | - |
