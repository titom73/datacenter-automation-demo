...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management1 | oob_management | oob | MGMT | 10.73.254.4/24 | 10.73.254.253 |
...
| --------- | --------------- | ------------ | --------- |
| pod01 | Vlan4094 | 172.31.253.4 | Port-Channel3 |
...
| --------- | ----------- | ---- | ----- | ----------- | ----------- | ------------- |
| Ethernet3 | MLAG_PEER_switch03_Ethernet3 | *trunk | *2-4094 | *- | *['LEAF_PEER_L3', 'MLAG'] | 3 |
| ethernet5 | SWITCH13_ethernet2 | *trunk | *110 | *- | *- | 5 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| ethernet1 | P2P_LINK_TO_SWITCH01_ethernet2 | routed | - | 172.31.255.13/31 | default | 9000 | false | - | - |
| ethernet2 | P2P_LINK_TO_SWITCH02_ethernet2 | routed | - | 172.31.255.15/31 | default | 9000 | false | - | - |
...
!
interface ethernet1
   description P2P_LINK_TO_SWITCH01_ethernet2
   no shutdown
   mtu 9000
   no switchport
...
!
interface ethernet2
   description P2P_LINK_TO_SWITCH02_ethernet2
   no shutdown
   mtu 9000
   no switchport
...
!
interface Ethernet3
   description MLAG_PEER_switch03_Ethernet3
   no shutdown
   channel-group 3 mode active
!
interface ethernet5
   description SWITCH13_ethernet2
   no shutdown
...
| --------- | ----------- | ---- | ---- | ----- | ----------- | ------------| --------------------- | ------------------ | ------- | -------- |
| Port-Channel3 | MLAG_PEER_switch03_Po3 | switched | trunk | 2-4094 | - | ['LEAF_PEER_L3', 'MLAG'] | - | - | - | - |
| Port-Channel5 | SWITCH13_Po1 | switched | trunk | 110 | - | - | - | - | 5 | - |
...
interface Port-Channel3
   description MLAG_PEER_switch03_Po3
   no shutdown
   switchport
...
| --------- | ----------- | --- | ---- | -------- |
| Vlan110 |  PR01-CLIENT  |  TENANT_A_CLIENT  |  -  |  false  |
...
| --------- | --- | ---------- | ------------------ | ------------------------- | ---- | ------ | ------- |
| Vlan110 |  TENANT_A_CLIENT  |  -  |  10.1.110.254/24  |  -  |  -  |  -  |  -  |
| Vlan3009 |  TENANT_A_CLIENT  |  172.31.253.7/31  |  -  |  -  |  -  |  -  |  -  |
...
interface Vlan110
   ...
   no shutdown
   vrf TENANT_A_CLIENT
   ip address virtual 10.1.110.254/24
!
interface Vlan3009
...
| 172.31.253.6 | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | TENANT_A_CLIENT | - | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | Inherited from peer group MLAG-IPv4-UNDERLAY-PEER | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 110 | 192.168.1.6:10110 | 10110:10110 | - | - | learned |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| TENANT_A_CLIENT | 192.168.1.6:10 | connected<br>static |
